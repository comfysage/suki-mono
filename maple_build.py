...
build_config = {
    ...
    "freeze_feature_list": {
        ...
        "ss01": Status.DISABLE,  # == === != !==
        "ss02": Status.DISABLE,  # [info] [trace] [debug] [warn] [error] [fatal] [vite]
        "ss03": Status.DISABLE,  # __
        "ss04": Status.DISABLE,  # >= <=
        "ss05": Status.DISABLE,  # {{ }}
        # ======
        # character variant:
        ...
        "cv02": Status.DISABLE,  # alt i
        "cv03": Status.DISABLE,  # alt a
        "cv04": Status.DISABLE,  # alt @
        "zero": Status.DISABLE,  # alt 0
        # ======
    },
